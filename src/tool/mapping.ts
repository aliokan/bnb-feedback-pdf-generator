...
export const mapping: TranslationMap = {
  ...
  "Example publication": "exampleUrl",
  ...
  "Re-use aanwezigen %": "re_use_attendees_percentage",
  "Number of found aanwezigen": "re_use_attendees_count",
  "Number of aanwezigen not linked": "re_use_attendees_not_linked_count",
  "Re-use stemmers %": "re_use_voters_percentage",
  "Number of found stemmers": "re_use_voters_count",
  "Number of stemmers not linked": "re_use_voters_not_linked_count",
  "Re-use voorzitters %": "re_use_chairmen_percentage",
  "Number of found voorzitters": "re_use_chairmen_count",
  "Number of voorzitters not linked": "re_use_chairmen_not_linked_count",
  "Re-use secretarissen %": "re_use_secretaries_percentage",
  "Number of found secretarissen": "re_use_secretaries_count",
  "Number of secretarissen not linked": "re_use_secretaries_not_linked_count",
  "foundVoorzitterInAanwezigen": "foundChairmanInAttendees_boolean",
  "foundSecretarisInAanwezigen": "foundSecretaryInAttendees_boolean",
  "foundVoorzitterThatIsAlsoAanwezigAsMandataris": "foundChairmanThatIsAlsoAttendeeAsMandatary_boolean",
};