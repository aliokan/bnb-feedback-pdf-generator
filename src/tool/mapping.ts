...
export const mapping: TranslationMap = {
  ...
  Bestuurseenheid: "adminsitrativeUnit_count",
  ...
  "BehandelingVanAgendapunt (Niveau 1)": "agendaItemHandling_count",
  ...
  "LegaleVerschijningsvorm - taal (Bonusniveau)": "legalApparance_lang_count",
  "Zitting (Niveau 1)": "session_count",
  "LegaleVerschijningsvorm - titel (Bonusniveau)": "legalApparance_title_count",
